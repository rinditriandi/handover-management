    ...
    <v-container grid-list-md fluid mb-5>
      <v-card>
        <v-toolbar card color="primary">
          <v-layout>
           <v-flex md4>
              <v-btn fab small color="blue-grey darken-4" dark :to="'/' + _sessionid + '/construction-progress'">
                  <v-icon>arrow_back_ios</v-icon>
              </v-btn>
            </v-flex>
          </v-layout>
          <v-flex md4 class="text-xs-center" mt-3>
            <v-toolbar-title class="dialog-title">Handover Construction Form</v-toolbar-title>
          </v-flex>
        ...
        <v-card-text>
          <v-container grid-list-md fluid>
            ...
            <v-layout>
                ...
                <v-flex md6>
                   <v-text-field label="Handover Date" v-model="input.handoverDate" readonly></v-text-field>
                </v-flex>
            </v-layout> <br>
            ...
            <v-layout row wrap>
              <v-flex md6>
                <v-select label="Vendor" autocomplete></v-select>
              </v-flex>
              <v-flex md6>
                <v-select label="SPK No" autocomplete></v-select>
              </v-flex>
            </v-layout>

            <v-layout>
                <v-flex md6>
                    <v-text-field label="Progress Date"></v-text-field>
                </v-flex>
                <v-flex md6>
                    <v-text-field label="Progress Actual"></v-text-field>
                </v-flex>
            </v-layout>
            
            <v-layout>
              <v-flex md6>
                <v-text-field label="Progress Plan"></v-text-field>
              </v-flex>
               <v-flex md6>
                <v-text-field label="Progress Actual"></v-text-field>
              </v-flex>
            ...
            <v-layout row wrap>
              <v-flex md12>
                <v-text-field label="Notes" multi-line></v-text-field>
              </v-flex>
            </v-layout>
          </v-container>
        </v-card-text>
    ...
    data() {
      return {
        ...
        headers1: [
                ...
                { class: 'datatable-header', text: 'SBP No', value: 'NoLetter', align: 'left', sortable: false },
                { class: 'datatable-header', text: 'Customer Name', value: 'CustomerName', align: 'left', sortable: false },
                { class: 'datatable-header', text: 'idx Product', value: 'SBPNo', align: 'left', sortable: false },
       ...
       /* ====================================== dialog method ==================================== */
        ...
        /* ====================================== logic functions ================================= */
         initialPage() {
            ...
            return this.ajaxGo('GET', this._handover + "/construction-progress", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
