    ...
    <div style="margin-top: -25px">
        <v-container grid-list-md fluid mb-5>
            ...
            <div class="text-xs-center mt-5 mb-3">
                <h3 class="page-title">Undangan Pengambilan PBB</h3>
            </div>
            ...
            <v-toolbar dark color="primary" class="mt-4">
                <v-layout>
                    <v-flex md4 ml-2>
                        ...
                        <span>Tambah Pengambilan PBB</span>
                        </v-tooltip>
                    </v-flex>
            ...
            <v-data-table :headers="headers1" :items="listItems" :pagination.sync="pagination1" :total-items="totalItems" class="elevation-1">
                ...
                <template slot="items" slot-scope="data">
                    <td>
                        ...
                        <v-tooltip top>
                            <v-btn fab dark color="indigo" slot="activator" class="btn-small-table" @click="testPrint(data.item.IDX_T_TakingPBBLetter)">
...
export default {
    ...
    methods: {
        ...
        initialPage() {
            ...
            return this.ajaxGo('GET', this._handover + "/pbb-letter", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
        ...
        dropdownCompany() {
            ...
            return this.ajaxGo('GET', this._handover + "/pbb-letter-form", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
        ...
        selectItem(data) {
            ...
            this.input.subject = 'Pemberitahuan Pengambilan SPPT PBB',
        ...
        /* ====================================== post method ====================================== */
         ...
         loadPBBLetter() {
            ...
            let id = {
                ...
                IDX_T_TakingPBBLetter : this.input.IDX_T_TakingPBBLetter
            };
            console.log(id);
            // push
            arrayList.push(id);
            
            return this.ajaxGo('GET', this._handover + "/pbb-letter-info", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
                // if (self.ajaxCheckReturn(data)) {
        ...
        saveData() {
            ...
            return this.ajaxGo('POST', this._handover + "/pbb-letter-save", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        updateData() {
            ...
            return this.ajaxGo('POST', this._handover + "/pbb-letter-edit", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        removeData() {
         ...
         approveData(param) {
            ...
            return this.ajaxGo('POST', this._handover + "/pbb-letter-approve", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
                    self.closeDialog('dialog1');
                    self.loadPage();
        ...
        sentData(param, data) {
            ...
            let id = {
                ...
                IDX_T_TakingPBBLetter : data.IDX_T_TakingPBBLetter,
                Courier : null,
                ResiNo : null,
                SentDate : null,
                ApprovalNotes : null,
        ...
        openDialog(param, type, data) {
            ...
            if (param == 'dialog1') {
                ...
                if (type == "Add") {
                    ...
                    // console.log(data);
                    this.input.IDX_T_TakingPBBLetter = data.IDX_T_TakingPBBLetter;
                    this.loadPBBLetter().then(() => { this.dialog1 = true;  });
                    // this.dialog1 = true;
                }
                else if (type == "Info") {
                    this.input.IDX_T_TakingPBBLetter = data.IDX_T_TakingPBBLetter;
        ...
        testPrint(id) {
            ...
            window.open('http://10.10.0.51:9014/web/handover/pbb-letterprint?id=' + id + '&&sessionid=' + this._sessionid + '&&formid=' + this.formid);
        }
    }
}
</script>
