    ...
    <div style="margin-top: -25px">
        <v-container grid-list-md fluid mb-5>
            ...
            <div class="text-xs-center mt-5 mb-3">
                <h3 class="page-title">Undangan Serah Terima 2</h3>
            </div>
            ...
            <v-toolbar dark color="primary" class="mt-4">
                <v-layout>
                    <v-flex md4 ml-2>
                        ...
                        <span>Tambah Serah Terima 2</span>
                        </v-tooltip>
                    </v-flex>
            ...
            <v-data-table :headers="headers1" :items="listItems" :pagination.sync="pagination1" :total-items="totalItems" class="elevation-1">
                ...
                <template slot="items" slot-scope="data">
                    ...
                    <td>
                        ...
                        <v-tooltip top>
                            <v-btn fab dark color="indigo" slot="activator" class="btn-small-table" @click="testPrint(data.item.IDX_T_HandoverLetter2,data.item.Type )">
                         ...
                         <v-divider class="mt-3"></v-divider> <br>
                          <v-layout row wrap>
                               <v-flex md6>
                                    ...
                                    v-model="menu2"
                                    :nudge-right="40"
                                    :return-value.sync="DateLetterBefore"
                                    lazy
                                    transition="scale-transition"
                                    offset-y
                                    full-width
                                    ...
                                    <v-text-field 
                                        slot="activator"
                                        v-model="input.DateLetterBefore"
                                        label="Tanggal Serah Terima Sebelumnya"
                                        prepend-icon="event"
                                        readonly
                                    ></v-text-field>
                                        <v-date-picker v-model="input.DateLetterBefore" @input="$refs.menu2.save(DateLetterBefore)" no-title scrollable></v-date-picker>
                                    </v-menu>
                                </v-flex>
                                <v-flex md6>
                                <v-text-field label="Tujuan" v-model="input.purpose"></v-text-field>
                            </v-flex>
                        </v-layout>
                          <v-layout row wrap>
                               <v-flex md6>
                ...
                <v-card-text>
                    <v-container grid-list-md fluid>
                        ...
                        <v-layout row wrap>
                         ...
                         <v-layout row wrap>
                            <v-flex md3>
                                <h4>Tanggal Serah Terima Sebelumnya:</h4>
                            </v-flex>
                            <v-flex md3>
                                <h4 class="info--text">{{ input.DateLetterBefore }}</h4>
                            </v-flex>
                             <v-flex md3>
                                <h4>Tujuan:</h4>
                            </v-flex>
                            <v-flex md3>
                                <h4 class="info--text">{{ input.purpose }}</h4>
                            </v-flex>
                        </v-layout>
...
export default {
    ...
    methods: {
        ...
        initialPage() {
            ...
            return this.ajaxGo('GET', this._handover + "/handover-letter2", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
       ...
       loadAdditionaList() {
        ...
        dropdownCompany() {
            ...
            return this.ajaxGo('GET', this._handover + "/handover-letter2-form", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
        ...
        selectItem(data) {
            ...
            this.input.subject = 'Undangan Serah Terima II (Kedua) Acara Serah Terima',
        ...
        /* ====================================== post method ====================================== */
         ...
         loadHandoverLetter2() {
            ...
            return this.ajaxGo('GET', this._handover + "/handover-letter2-info", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
                // if (self.ajaxCheckReturn(data)) {
        ...
        saveData() {
            ...
            return this.ajaxGo('POST', this._handover + "/handover-letter2-save", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        updateData() {
            ...
            return this.ajaxGo('POST', this._handover + "/handover-letter2-edit", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        approveData(param) {
            ...
            return this.ajaxGo('POST', this._handover + "/handover-letter2-approve", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
                    self.closeDialog('dialog1');
                    self.loadPage();
        ...
        sentData(param, data) {
            ...
            let id = {
                ...
                IDX_T_HandoverLetter2 : data.IDX_T_HandoverLetter2,
                Courier : null,
                ResiNo : null,
                SentDate : null,
                ApprovalNotes : null,
            ...
            return this.ajaxGo('POST', this._handover + "/handover-letter2-sent", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
                    // self.closeDialog('dialog1');
                    self.loadPage();
        ...
        openDialog(param, type, data) {
            ...
            if (param == 'dialog1') {
                ...
                if (type == "Add") {
                    ...
                    // console.log(data);
                    this.input.IDX_T_HandoverLetter2 = data.IDX_T_HandoverLetter2;
                    this.loadHandoverLetter2().then(() => { this.dialog1 = true;  });
                    // this.dialog1 = true;
                }
                else if (type == "Info") {
                    this.input.IDX_T_HandoverLetter2 = data.IDX_T_HandoverLetter2;
        ...
        testPrint(id, tipe) {
            if(tipe == 'RUMAH') {
                window.open('http://10.10.0.51:9014/web/handover/handover-letterprint2-rumah?id=' + id + '&&sessionid=' + this._sessionid + '&&formid=' + this.formid);
            }
            else if(tipe == 'RUKO') {
                window.open('http://10.10.0.51:9014/web/handover/handover-letterprint2-ruko?id=' + id + '&&sessionid=' + this._sessionid + '&&formid=' + this.formid);
            }
            else if(tipe == 'KAVLING') {
                window.open('http://10.10.0.51:9014/web/handover/handover-letterprint2-kavling?id=' + id + '&&sessionid=' + this._sessionid + '&&formid=' + this.formid);
            }
