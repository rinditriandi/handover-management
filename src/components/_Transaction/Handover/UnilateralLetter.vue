    ...
    <div style="margin-top: -25px">
        <v-container grid-list-md fluid mb-5>
            ...
            <div class="text-xs-center mt-5 mb-3">
                <h3 class="page-title">Undangan Serah Terima Sepihak</h3>
            </div>
            ...
            <v-toolbar dark color="primary" class="mt-4">
                <v-layout>
                    <v-flex md4 ml-2>
                        ...
                        <span>Tambah Serah Terima Sepihak</span>
                        </v-tooltip>
                    </v-flex>
            ...
            <v-data-table :headers="headers1" :items="listItems" :pagination.sync="pagination1" :total-items="totalItems" class="elevation-1">
                ...
                <template slot="items" slot-scope="data">
                    <td>
                        ...
                        <v-tooltip top>
                            <v-btn fab dark color="indigo" slot="activator" class="btn-small-table" @click="testPrint(data.item.IDX_T_UnilateralLetter)">
                         ...
                         <v-divider class="mt-3"></v-divider> <br>
                          <v-layout row wrap>
                             <v-flex md6>
                                ...
                                v-model="menu5"
                                :nudge-right="40"
                                :return-value.sync="input.DateLetterBefore"
                                lazy
                                transition="scale-transition"
                                offset-y
                                full-width
                                ...
                                <v-text-field 
                                    ...
                                    label="Tanggal Undangan Serah Terima Sebelumnya"
                                    prepend-icon="event"
                                    readonly
                                ></v-text-field>
                                    <v-date-picker v-model="input.DateLetterBefore" @input="$refs.menu5.save(input.DateLetterBefore)" no-title scrollable></v-date-picker>
                                </v-menu>
                            </v-flex>    
                             <v-flex md6>
                          ...
                          <v-layout row wrap>
                             <v-flex md6>
                                ...
                                v-model="menu"
                                :nudge-right="40"
                                :return-value.sync="input.CountedDate"
                                lazy
                                transition="scale-transition"
                                offset-y
                                full-width
                                ...
                                <v-text-field 
                                    slot="activator"
                                    v-model="input.CountedDate"
                                    label="Tanggal Terhitung"
                                    prepend-icon="event"
                                    readonly
                                ></v-text-field>
                                    <v-date-picker v-model="input.CountedDate" @input="$refs.menu.save(input.CountedDate)" no-title scrollable></v-date-picker>
                                </v-menu>
                            </v-flex>    
                             <v-flex md6>
...
export default {
    ...
    data() {
        return {
            ...
            flagWatch: false,
            formid: 'HOL05',
            page: 'Undangan Serah Terima Sepihak',
            type: undefined,
    ...
    methods: {
        ...
        initialPage() {
            ...
            return this.ajaxGo('GET', this._handover + "/unilateral-letter", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
      ...
      loadAdditionaList() {
        ...
        selectItem(data) {
            ...
            this.input.subject = 'Undangan Serah Terima Sepihak',
            this.input.purpose = 'Undangan Pengecekan Rumah',
        ...
        /* ====================================== post method ====================================== */
         ...
         loadUnilateralLetter() {
            ...
            let id = {
                ...
                IDX_T_UnilateralLetter : this.input.IDX_T_UnilateralLetter
            };
            console.log(id);
            // push
            arrayList.push(id);
            
            return this.ajaxGo('GET', this._handover + "/unilateral-letter-info", arrayList, this._fetchingLoader, this._withData, this._withoutSnackBar).then(function(data) {
                // if (self.ajaxCheckReturn(data)) {
                    ...
                    self.input.CountedDate = data[3][0].CountedDate ? self.moment(data[3][0].CountedDate).format('YYYY-MM-DD') : '';;
        ...
        saveData() {
            ...
            let id = {
                ...
                CountedDate: this.input.CountedDate,
            ...
            return this.ajaxGo('POST', this._handover + "/unilateral-letter-save", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        updateData() {
              // validation
            if (this.input.ProductID == undefined) { this.sendSnackbar("Warning", "Please Selecet Product", this._otherTimeout); return false; }
            ...
            return this.ajaxGo('POST', this._handover + "/unilateral-letter-edit", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
        ...
        approveData(param) {
            ...
            return this.ajaxGo('POST', this._handover + "/unilateral-letter-approve", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
                    self.closeDialog('dialog1');
                    self.loadPage();
        ...
        sentData(param, data) {
            ...
            let id = {
                ...
                IDX_T_UnilateralLetter : data.IDX_T_UnilateralLetter,
                Courier : null,
                ResiNo : null,
                SentDate : null,
                ApprovalNotes : null,
        ...
        openDialog(param, type, data) {
            ...
            if (param == 'dialog1') {
                ...
                if (type == "Add") {
                    ...
                    // console.log(data);
                    this.input.IDX_T_UnilateralLetter = data.IDX_T_UnilateralLetter;
                    this.loadUnilateralLetter().then(() => { this.dialog1 = true;  });
                    // this.dialog1 = true;
                }
                else if (type == "Info") {
                    this.input.IDX_T_UnilateralLetter = data.IDX_T_UnilateralLetter;
        ...
        testPrint(id) {
            ...
            window.open('http://10.10.0.51:9014/web/handover/unilateral-letterprint?id=' + id + '&&sessionid=' + this._sessionid + '&&formid=' + this.formid);
        }
    }
}
</script>
