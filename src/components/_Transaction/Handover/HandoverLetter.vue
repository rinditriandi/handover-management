    ...
    <div style="margin-top: -25px">
        <v-container grid-list-md fluid mb-5>
            ...
            <div class="text-xs-center mt-5 mb-3">
                <h3 class="page-title">Undangan Serah Terima</h3>
            </div>
    ...
    methods: {
       ...
       loadAdditionaList() {
        ...
        sentData(param, data) {
            ...
            return this.ajaxGo('POST', this._handover + "/handover-letter-sent", arrayList, this._savingLoader, this._withData, this._withSnackBar).then(function(data) {
                if (self.ajaxCheckReturn(data)) {
                    self.input = {};
                    // self.closeDialog('dialog1');
                    self.loadPage();
